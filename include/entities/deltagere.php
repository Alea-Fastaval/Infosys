...
';
  ...
  public function getPronoun(String $lang = null) {
    ...
    if ($this->pronouns == "ask") {
      return $lang == 'da' ? "Spørg mig" : "Ask me";
    }

    if ($this->pronouns == "none") {
      return $lang == 'da' ? "Ingen" : "None";
    }

    $single_pronouns = [
      'en' => [
        'ns' => 'They', // neutral subject
        'no' => 'Them', // neutral object
        'fs' => 'She', // feminine subject
        'fo' => 'Her', // feminine object
        'ms' => 'He', // masculine subject
        'mo' => 'Him', // masculine object
      ],
      'da' => [
        'ns' => 'De', // neutral subject
        'no' => 'Dem', // neutral object
        'fs' => 'Hun', // feminine subject
        'fo' => 'Hende', // feminine object
        'ms' => 'Han', // masculine subject
        'mo' => 'Ham', // masculine object
      ],
    ];

    if (strlen($this->pronouns) == 2) {
      return $single_pronouns[$lang][$this->pronouns];
    }

    $parts = str_split($this->pronouns, 2);
    return $single_pronouns[$lang][$parts[0]] . "/" . $single_pronouns[$lang][$parts[1]];
  }
