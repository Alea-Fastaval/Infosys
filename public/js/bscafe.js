...
var BSCafe = (function ($, window) {
    ...
    var module = {
        ...
        handleUploadSpreadsheet: function () {
            ...
            module.$dialog = $('<div><p>Copypaste spreadsheet data ind her:<br>Kolonnerne skal have følgende overskrifter for at upload accepteres: Navn, Ejer, BGG-id, Kommentar, Designerspil.<br>Kolonner skal være adskilt med ; og uden anførselstegn.<br>Designerspil angives med 0 eller 1<br><strong>VÆR OPMÆRKSOM PÅ AT AL DATA SLETTES!</strong></p><textarea class="spreadsheet-upload"></textarea><button class="upload">Upload</button></div>');
